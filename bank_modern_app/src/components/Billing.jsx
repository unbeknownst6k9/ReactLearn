    ...
    <section id='product' className={`${layout.sectionReverse}`}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-row flex-wrap sm:mt-10 nt-6'>
          <img src={apple} alt='apple pay' className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
          <img src={google} alt='google pay' className='w-[144px] h-[43px] object-contain mr-5 cursor-pointer'/>
        </div>
      </div>
    </section>
  )
